...
function timeLabelNightTime (v) {
  let times = [ '6 AM', '7 AM', '8 AM', '9 AM','10 AM', '11 AM', '12 PM',
...
function dayOfWeekLabelNightTime (v) {
...
export default {dateLabel, timeLabelSimple, timeLabelAdjusted, timeLabelNightTime, dayOfWeekLabel, dayOfWeekLabelAdjusted, dayOfWeekLabelNightTime, stringLabel};
