      ...
      <div>
        <div className='container' style={styles.container}>
          ...
          <Text>
            ...
            {<img src='/icons/pin.png' width="90%" style={{width: '100%', height: '100%', display: 'block', marginLeft: 'auto', marginRight: 'auto', border: '1px solid black'}} />}

            <p>The extension icon will appear in the upper right corner for Chrome users. </p>
          ...
          <Text>
            ...
            <Grid hAlign="space-around">
              <GridRow>
                <GridCol>
                  <View as='div' borderWidth='medium' borderRadius='medium' padding='small'>
                    ...
                    <Text>
                      <p><strong>When</strong>: now (click the link at the bottom of this page)</p>
                ...
                <GridCol>
                  <View as='div' borderWidth='medium' borderRadius='medium' padding='small'>
                    ...
                    <Text>
                      <p><strong>When</strong>: in one week, you will be contacted via Prolific</p>
                      <p><strong>Steps</strong>:</p>
                      <p style={{'marginLeft':'1em'}}>
              ...
              <GridRow>
                <GridCol>
                  <Alert variant='warning'>
                    You must access the extension's dashboard at least three times on three seperate days during the week. Failure to do so will be considered unsuccessful participation.
                  </Alert>
                </GridCol>
              </GridRow>
            </Grid>
          ...
          <Text>
            <p>Please continue where you left off in the survey. Feel free to close this tab. </p>
          </Text>
